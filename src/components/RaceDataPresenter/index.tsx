...
const jsonViewerStyles = { ...darkStyles, container: 'app-json-viewer' };
        ...
        return <div>
            ...
            {showRawJsonTools && (
                <>
                    ...
                    <div className="app-json-download">
                        <button
                            onClick={() => {
                    ...
                    <JsonView data={toJson(RaceSimulateDataSchema, this.props.raceData) as object} style={jsonViewerStyles} shouldExpandNode={collapseAllNested} />
                </>
            )}
        </div>;
    }
